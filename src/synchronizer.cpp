...
namespace syncher {
    ...
    void Syncher::callback(const ImageConstPtr &camera_image, const ImageConstPtr &camera1_image,
                           const ImageConstPtr &boson_image) {
        ...
        syncImages.camera = *camera_image;
        syncImages.camera1 = *camera1_image;
        syncImages.boson = *boson_image;
